...
<table class="table table-striped">
    ...
    <tr>
        <td><?= $form->field($modelD, "[{$i}]serviceDetailId")->widget(Select2::classname(), [
                    'data'=> ArrayHelper::map(app\models\MServiceDetail::find()->all(),'serviceDetailId','serviceDetailJudul'),
                    'options' => ['placeholder' => '-- Services --'],'pluginOptions' => ['allowClear' => true]])->label("Service Detail") ?></td>
    </tr>
    <tr>
        <td><?= $form->field($modelD, "[{$i}]kapasitasId")->widget(Select2::classname(), [
                    'data'=> ArrayHelper::map(app\models\MKapasitasDetail::find()->all(),'kapasitasId','kapasitasJudul'),
                    'options' => ['placeholder' => '-- Services --'],'pluginOptions' => ['allowClear' => true]])->label("Satuan") ?></td>
    </tr>
    <tr>
