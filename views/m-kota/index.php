...
function tombolCreate(){
      $title = Yii::t('app', 'New Kota');
      $url = Url::toRoute(['/m-kota/create']);
      $options = ['id'=>'kota-id-create',
                    'data-pjax' => 0,
  ...
  */
  function tombolView($url, $model){
        ...
        $label = $icon . ' ' . $title;
        $url = Url::toRoute(['/m-kota/view','id'=>$model->kotaId]);
        $options1 = [
                    'id'=>'view-kota-id',
  ...
  */
  function tombolUpdate($url, $model){
        ...
        $label = $icon . ' ' . $title;
        $url = Url::toRoute(['/m-kota/update','id'=>$model->kotaId]);
        $options1 = [
                    'id'=>'edit-kota-id',
                    // 'class'=>"btn btn-default btn-xs",      
                    // 'style'=>['width'=>'170px', 'height'=>'25px','border'=> 'none','background-color'=>'white'],  
  ...
  */
  function tombolDelete($url, $model){
        ...
        $label = $icon . ' ' . $title;
        $url = Url::toRoute(['/m-kota/delete','id'=>$model->kotaId]);
        $options1 = [ 'id'=>'delete-kota-id',
                       'data' => [
...
$attDinamik =[];
$headColomnBT=[
    ['ID' =>0, 'ATTR' =>['FIELD'=>'kotaNama','SIZE' => '30px','label'=>'Kota','align'=>'left','warna'=>'73, 162, 182, 1','grp'=>false]],
    ];
